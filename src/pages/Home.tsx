...
import sectionOneImg from "../assets/pepper/fireBar2.gif";
...
import parachute from '../assets/showcase/parachute.png'
...
const Home = (props: Props) => {
  ...
  const gangData = [
    { id: 1, src: gangCofounder2, name: "RICOCHE", job: "CO - Founder" },
    { id: 2, src: gangCofounder, name: "DECKRO", job: "co - Founder" },
    { id: 3, src: gangMarketing, name: "SPEEDY", job: "mARKETING" },
    { id: 4, src: gangDesigner, name: "PINTO", job: "gRAPHIC DESIGN" },
    { id: 5, src: gangDeveloper, name: "CASPER", job: "DEVELOPER" }
  ]
  ...
  return (
    <Container className={classes.motherWrap} maxWidth="xl">
      ...
      {/* <Dialog
        ...
        onClose={closeDialog}
        maxWidth="lg"
        PaperProps={{ style: { borderRadius: 15, background: 'transparent' } }}
            ...
            <Grid container spacing={3} style={{ borderBottom: '1px solid #fff8', paddingBottom: '4em' }}>
              <Grid item sm={12} md={8} className={classes.subWrapImg} style={{ justifyContent: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }} >
                ...
                <div style={{ textAlign: 'left' }}>
                  ...
                  <span className={classes.whyWheSubText}>
                    Peño is the first of its kind. A token solely made to help investors increase their crypto holdings. Deployed on Binance Chain to deter high gas fees
